...
* Metamorphic Rocks
  ...
  :reveal_background: slides/MetaRx_beamer_000.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/Meta_Rx_Lab_s01.ogg">
 
* Metamorphic Rock Classification
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/MetaRx_beamer_001.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/Meta_Rx_Lab_s02.ogg">
 
* Metamorphic Minerals and Grade
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/MetaRx_beamer_002.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/Meta_Rxls_Lab_s03.ogg">
 
* Doing the Lab
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/MetaRx_beamer_003.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/Meta_Rx_Lab_s04.ogg">
 
* Doing the Lab
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/MetaRx_beamer_004.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/Meta_Rx_Lab_s05.ogg">

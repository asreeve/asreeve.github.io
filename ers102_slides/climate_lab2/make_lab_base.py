...
class make_base:
    ...
    '''
    def __init__(self,base_path="./", pdf_file="climate_beamer.pdf",topic="climate_lab"):
        self.lect_path=Path("./slides")
        self.topic=topic 
        self.pdf_file=pdf_file
        self.base_path=Path(base_path)
        self.dummy_audio="#+REVEAL_HTML: <p class ='fragment' data-audio-src='audio/SolveThePuzzle_sss.ogg'>\n \n"
    ...
    def make_org(self):
        ...
        * one for writing note/talking points
        ...
        for h1,slide in zip(self.slide_titles,png_slides):
            ...
            slide_no=int(slide[-7:-4])
            new_file1.write(self.dummy_audio.replace('sss','s'+f'{slide_no+1:02}'))

...
* Section 
  ...
  :reveal_background: slides/08_except_000.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/08_except_s01.ogg">
* Introduction to Exceptions
  :PROPERTIES:
  :reveal_background_size: 1100px 
  :reveal_background: slides/08_except_001.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/08_except_s02.ogg">
* Using if and try-except Clauses for errors
  :PROPERTIES:
  :reveal_background_size: 1100px 
  :reveal_background: slides/08_except_002.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/08_except_s03.ogg">
* Common Exception
  :PROPERTIES:
  :reveal_background_size: 1100px 
  :reveal_background: slides/08_except_003.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/08_except_s04.ogg">
* Catching and Raising exceptions
  :PROPERTIES:
  :reveal_background_size: 1100px 
  :reveal_background: slides/08_except_004.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/08_except_s05.ogg">

...
* Topographic Maps Bottom half of Princeton ME 7.5 minute quad
  ...
  :reveal_background: slides/topomap_beamer_000.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s01.ogg">
 
* Scale
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/topomap_beamer_001.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s02.ogg">
 
* Geographic location
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/topomap_beamer_002.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s03.ogg">
 
* Contour Lines
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/topomap_beamer_003.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s04.ogg">
 
* Contour Lines
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/topomap_beamer_004.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s05.ogg">
 
* Contour Lines
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/topomap_beamer_005.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s06.ogg">
 
* Contour Lines
  :PROPERTIES:
  :reveal_background_size: 1100px
  :reveal_background: slides/topomap_beamer_006.png
  :reveal_background_trans: slide
  :END:
 
#+REVEAL_HTML: <p class ="fragment" data-audio-src="audio/topo_lab_s07.ogg">
